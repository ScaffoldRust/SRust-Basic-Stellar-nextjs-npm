...
//           <SheetContent
//             side="right"
//             className="w-[280px] sm:w-[320px] bg-slate-900 border-slate-700"
//           >
...
//                   {theme.appName}
//                 </span>
//                 <Badge className="ml-auto text-xs bg-slate-800 text-slate-400 hover:bg-slate-800">
//                   Beta
//                 </Badge>
//               </div>
...
//                   <NavigationMenuLink className="flex items-center gap-2 font-medium px-4 py-2 rounded-md transition-colors text-slate-200 hover:text-cyan-400 hover:bg-slate-800/50">
//                     {navlink.id === 1 && (
